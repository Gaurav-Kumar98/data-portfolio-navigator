  ...
  (
    ...
    const handleDragEnd = (
      ...
      if (Math.abs(info.offset.x) > 100) {
        ...
        navigateToIndex((currentIndex + direction + testimonials.length) % testimonials.length)
      }
    }

    const navigateToIndex = (newIndex: number) => {
      setExitX(newIndex > currentIndex ? -100 : 100)
      setTimeout(() => {
    ...
    const handlePrevious = () => {
      navigateToIndex((currentIndex - 1 + testimonials.length) % testimonials.length)
    }

    const handleNext = () => {
      navigateToIndex((currentIndex + 1) % testimonials.length)
    }
            ...
            return (
              ...
              >
                ...
                <div className="p-8 flex flex-col items-center gap-6 h-full">
                  ...
                  <p className="text-center text-base text-gray-600 dark:text-muted-foreground leading-relaxed">
                ...
                <button
                  ...
                  className={cn(
                    ...
                    index === currentIndex
                      ...
                      : "bg-gray-300 hover:bg-gray-400 dark:bg-muted-foreground/30 dark:hover:bg-muted-foreground/50",
                  )}
