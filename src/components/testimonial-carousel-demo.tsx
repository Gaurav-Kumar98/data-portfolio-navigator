    ...
    <section className="py-16 px-4">
      <div className="container mx-auto">
        <div className="text-center mb-12">
          <h2 className="text-3xl font-bold mb-4">What colleagues and clients say</h2>
          <p className="text-muted-foreground">
            Feedback from professionals who have collaborated with me on data engineering and AI projects
          </p>
        </div>
        <TestimonialCarousel 
